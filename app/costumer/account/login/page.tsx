...
export default function Login({}) {
  ...
  const onSubmit = async (e) => {
    ...
    if (email.current == "" || password.current == "") {
      ...
      setErro(true);
    } else if (!email.current.includes("@" || ".")) {
    ...
    <div className="container text-color-5 bg-color-3 flex items-center justify-center">
      <div className="p-8 shadow-md border border-color-5/10 w-[400px] mt-16 rounded-xl flex flex-col gap-6">
        ...
        <button
          ...
          className="bg-color-5/5 flex items-center justify-center gap-4 font-semibold text-lg w-full py-2 rounded-md border border-color-5/20 text-color-5/50"
        >
